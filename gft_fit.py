...
from gft_internals import my_datasets, parse_eqn, parse_args
...
def training_function(args):
    ...
    if eqn_type == parse_eqn.eqn_types['classify']:
        ...
        from gft_internals import fit_for_classify_spans
