...
def fit(args, eqn, accelerator, datasets):
    ...
    assert eqn['eqn_type'] == parse_eqn.eqn_types['classify_classic'], 'fit_for_classify is for eqn_type: classify, but eqn_type is: ' + str(parse_eqn.eqn_types_list[eqn['eqn_type']])
