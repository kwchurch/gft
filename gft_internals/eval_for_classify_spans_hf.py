...
def my_eval(args, eqn, accelerator, raw_datasets):
    ...
    assert eqn['eqn_type'] == parse_eqn.eqn_types['classify_spans'], 'eval_for_classify_spans: eqn_type is classify, but eqn_type is: ' + str(parse_eqn.eqn_types_list[eqn['eqn_type']])
